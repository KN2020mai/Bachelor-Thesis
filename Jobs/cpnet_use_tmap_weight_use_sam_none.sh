...
### name the job
#SBATCH --job-name=cpnet_use_tmap_weight_use_sam_none
### job run time
#SBATCH --time=10:00:00
### declare the merged STDOUT/STDERR file
#SBATCH --output=output.%J.cpnet_use_tmap_weight_use_sam_none.txt
###
...
python3 train_sartorius.py --model cpnet --use-tmap --tmap weight