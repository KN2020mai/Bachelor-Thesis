...
### name the job
#SBATCH --job-name=cpnet_use_tmap_none_use_sam_tail
### job run time
#SBATCH --time=10:00:00
### declare the merged STDOUT/STDERR file
#SBATCH --output=output.%J.cpnet_use_tmap_none_use_sam_tail.txt
...
python3 train_sartorius.py --model cpnet --use-sam --sam-position tail