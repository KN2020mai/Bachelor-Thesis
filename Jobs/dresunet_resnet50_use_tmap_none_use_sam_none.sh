...
### name the job
#SBATCH --job-name=dresunet_resnet50_use_tmap_none_use_sam_none
### job run time
#SBATCH --time=10:00:00
### declare the merged STDOUT/STDERR file
#SBATCH --output=output.%J.dresunet_resnet50_use_tmap_none_use_sam_none.txt
###
...
python3 train_sartorius.py --model dresunet --backbone resnet50